/* jenner-check bundle: %shutter_chance, if_condition= parameter
   Source: shutter_chance/06_macros/shutter_chance.sas (macro definition, unmodified)
   Caller: adapted from the README's own "Usage example" for if_condition=
   (data wk1; set sashelp.class; %shutter_chance(...if_condition=%nrbquote(SEX="F" and AGE=15)...));
